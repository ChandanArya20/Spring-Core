...
public class SetterInjectionApplicationCobtextContainer {

	public static void main(String[] args) throws Exception {

		System.out.println("***********ApplicationContext container starting************");

		ClassPathXmlApplicationContext factory = new ClassPathXmlApplicationContext("C:\\Users\\Chandan\\SpringFramwork\\Spring-01\\applicationContext.xml");
